...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر النــجار
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == jmub.uid:
            buttons = [
                [Button.inline("معلومات النــجار", data="AOMRDB")],
                [
...
المطور : @HssHH ❤️‍🔥
قناة السورس : @Hasoni_lq ❤️‍🔥
قناة الشعر : @Alnajar ❤️‍🔥""",
        buttons=[
...
async def varssett(event):
    await event.edit(
        """اهلا بك في قائمة معلومات  سورس النجار  هذه بعض المعلومات عن السورس:

- سورس النجار يمتلك اكثر من 100 أمر 
- النــجار هو افضل سورس عربي يتميز بالحماية

قناة السورس:  @Hasoni_lq
قناة الشعر: @Alnajar
المطور: @HssHH""",
        buttons=[
            [Button.inline("رجوع", data="namevar")],
